...
<div class="row pb-5 justify-content-center">
    ...
    <div class="col-lg-12/// mb-3">
        <div class="card">
            <div class="card-header mb-3 p3 bg-success text-white">
                <div class="row">
                    <div class="col pt-1">
                        Key Information
                    </div>
                        <div class="col text-end">
                     <a class="btn btn-sm btn-outline-light" href="<?= site_url('keys') ?>"><i class="fa-solid fa-file-lines fa-fade" style="--fa-animation-duration: 5s; color: #ff0505;"></i> KEYS</a>
                     <a class="btn btn-outline-light btn-sm" href="<?= site_url('keys/generate') ?>"><i class="fa-solid fa-file-plus fa-flip" style="--fa-animation-duration: 4s; color: yellow;"> </i></a>
                       <a class="btn btn-outline-light btn-sm" href="<?= site_url('keys/name-generate') ?>"><i class="fa-solid fa-file-pen fa-flip" style="--fa-animation-duration: 8s; color: yellow;"> </i></a>
                   </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="registrator" id="registrator" disabled="disabled" class="form-control" placeholder="nata" aria-describedby="help-registrator" value="<?= old('registrator') ?: $key->registrator ?>">
                    ...
                    <div class="col-lg-6">
                        <button type="submit" class="btn btn-outline-primary btnUpdate">Update And Change This User Key</button>
                    </div>
                    <?= form_close() ?>
...
<script>
    $(document).ready(function() {
        ...
        if (level != 1) $("#registrator, #expired_date, #game, #max_devices, #devices").attr('disabled', true);
    ...
    $(document).ready(function() {
        var level = "<?= $user->level ?>";
        if (level == 2) $("#expired_date").attr('disabled', false);
        $("input, select, textarea").change(function() {
            $(".btnUpdate").attr('disabled', false);
        });
    });
