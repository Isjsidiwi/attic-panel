...
<head>
    ...
    <title>VIP PANEL - Reset Password</title>
                    ...
                    <div class="p-4 pb-5">
                        ...
                        <?= form_open('reset', ['id' => 'resetForm']) ?>
                            ...
                            <div class="text-center">
                                <span style="color: rgba(255, 255, 255, 0.5);">Remember your password? </span>
                                <a href="<?= site_url('login') ?>" class="register-link">Back to Login</a>
                            </div>
                        <?= form_close() ?>
                    </div>
                </div>
