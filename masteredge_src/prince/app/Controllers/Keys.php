...
class Keys extends BaseController
{
    ...
    public function __construct()
    {
     ...
     $this->userId=session()->get('userid');
        ...
        $this->duration = [
            2 => '2 Hours &mdash; ₹0/Device',
            5 => '5 Hours &mdash; ₹50/Device',
            24 => '1 Days &mdash; ₹180/Device',
            72 => '3 Days &mdash; ₹350/Device',
            168 => '7 Days &mdash; ₹850/Device',
            336 => '14 Days &mdash; ₹1200/Device',
            720 => '30 Days &mdash; ₹2000/Device',
            1440 => 'Full Session &mdash; ₹3500/Device',
            8766 => 'Life time &mdash; ₹6000/Device',
        ];
        ...
        $loopcount = 2;
          ...
          if ($reduceCheck < 0) {
              ...
              //}
                 ...
                 for($i=1;$i<$loopcount;$i++){
                    $license = $user->username. $drtn. 'Hsr'. random_string('alnum', 5);
                       $model = $this->model;
if ($twst == "custom") {
